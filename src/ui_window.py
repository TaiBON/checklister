...
class Ui_Window(object):
    def setupUi(self, Window):
        ...
        self.butFormatName = QtWidgets.QPushButton(self.tab)
        self.butFormatName.setGeometry(QtCore.QRect(450, 80, 131, 32))
        self.butFormatName.setObjectName("butFormatName")
        self.label_12 = QtWidgets.QLabel(self.tab)
        self.label_12.setGeometry(QtCore.QRect(0, 0, 201, 39))
        self.label_12.setObjectName("label_12")
        self.checkBox = QtWidgets.QCheckBox(self.tab)
        self.checkBox.setGeometry(QtCore.QRect(210, 90, 121, 20))
        self.checkBox.setChecked(True)
        self.checkBox.setObjectName("checkBox")
        self.gridLayoutWidget.raise_()
        self.horizontalLayoutWidget_2.raise_()
        self.butFormatName.raise_()
        self.butFormatName.raise_()
    ...
    def retranslateUi(self, Window):
        ...
        self.butSelectExcel.setToolTip(_translate("Window", "<html><head/><body><p>Select export checklist file. Supported file formats: Microsoft Word 2007 (.docx), Open document format (.odt), markdown (.md). Default is docx and markdown.</p></body></html>"))
        self.butSelectExcel.setText(_translate("Window", "Select file ..."))
        self.label_10.setText(_translate("Window", "Column number"))
        self.lineExcelColnum.setText(_translate("Window", "1"))
        self.butFormatName.setText(_translate("Window", "Format"))
        self.label_12.setText(_translate("Window", "Choose file to format names:"))
        self.checkBox.setText(_translate("Window", "with header"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Window", "Format"))
