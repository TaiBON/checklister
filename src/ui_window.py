...
class Ui_Window(object):
    def setupUi(self, Window):
        ...
        self.gridLayoutWidget_7 = QtWidgets.QWidget(self.tabCombine)
        self.gridLayoutWidget_7.setGeometry(QtCore.QRect(60, 20, 461, 71))
        self.gridLayoutWidget_7.setObjectName("gridLayoutWidget_7")
        self.gridLayout_8 = QtWidgets.QGridLayout(self.gridLayoutWidget_7)
        self.gridLayout_8.setObjectName("gridLayout_8")
        self.lineCombineChecklists = QtWidgets.QLineEdit(self.gridLayoutWidget_7)
        self.lineCombineChecklists.setObjectName("lineCombineChecklists")
        self.gridLayout_8.addWidget(self.lineCombineChecklists, 2, 0, 1, 1)
        self.label_11 = QtWidgets.QLabel(self.gridLayoutWidget_7)
        self.label_11.setObjectName("label_11")
        self.gridLayout_8.addWidget(self.label_11, 1, 0, 1, 1)
        self.butCombineChecklists = QtWidgets.QPushButton(self.gridLayoutWidget_7)
        self.butCombineChecklists.setObjectName("butCombineChecklists")
        self.gridLayout_8.addWidget(self.butCombineChecklists, 2, 1, 1, 1)
        self.tabWidget.addTab(self.tabCombine, "")
        self.horizontalLayoutWidget_4 = QtWidgets.QWidget(Window)
        self.horizontalLayoutWidget_4.setGeometry(QtCore.QRect(450, 670, 179, 51))
