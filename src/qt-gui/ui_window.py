...
class Ui_Window(object):
    def setupUi(self, Window):
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(10, 10, 411, 68))
    ...
    def retranslateUi(self, Window):
        ...
        self.treeWidget.headerItem().setText(2, _translate("Window", "Localname"))
        ...
        self.label_5.setText(_translate("Window", "中文俗名"))
