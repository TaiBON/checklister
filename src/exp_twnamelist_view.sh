...
${PGSQL} -d ${DB} -qA -t -c "SELECT * FROM nomenclature.twredlist2017_view" > ../data/twredlist2017.csv
${PGSQL} -d ${DB} -qA -t -c "SELECT * FROM nomenclature.twnamelist_synonym_view" > ../data/twnamelist_pg_synonym.csv
