...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 624, 500))
        ...
        self.gridLayout_2.addWidget(self.lineSlist, 1, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.labelBatch, 1, 0, 1, 2)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.butGenerateSp, 4, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.tabWidget_2, 2, 0, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.butSlist, 1, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lineOutputFilename, 0, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.labelExportFile, 0, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.butSelectOutput, 0, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.treeWidget, 3, 0, 1, 4)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/export.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/batch.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/delete.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/delete_all.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/bug_report.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/tropicos.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/save_txt.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/execute_export.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/nomenmatch.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/addspecies.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionTropicos.setText(_translate("MainWindow", "actionTropicos"))
        ...
        self.actionNomenMatch.setText(_translate("MainWindow", "actionNomenMatch"))
        ...
        self.actionAddSpecies.setText(_translate("MainWindow", "Add species"))
