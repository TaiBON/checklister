...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 502, 506))
        ...
        self.toolBarEdit.setFocusPolicy(QtCore.Qt.FocusPolicy.ClickFocus)
        self.toolBarEdit.setStyleSheet("QToolBar{spacing: 0px;}")
        self.toolBarEdit.setAllowedAreas(QtCore.Qt.ToolBarArea.AllToolBarAreas)
        self.toolBarEdit.setIconSize(QtCore.QSize(40, 40))
        self.toolBarEdit.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonIconOnly)
        self.toolBarEdit.setFloatable(True)
        self.toolBarEdit.setObjectName("toolBarEdit")
        MainWindow.addToolBar(QtCore.Qt.ToolBarArea.TopToolBarArea, self.toolBarEdit)
        ...
        MainWindow.addToolBar(QtCore.Qt.ToolBarArea.TopToolBarArea, self.toolBarSearch)
        ...
        self.scrollAreaWidgetTaxonInfo.setGeometry(QtCore.QRect(0, 0, 576, 484))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/export.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/batch.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/delete_all.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/bug_report.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/tropicos.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/save_txt.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/execute_export.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/nomenmatch.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/addspecies_32x32.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/icons/deselect.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icons/select_all.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icons/new.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icons/search.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.webDBSelectButton.setItemText(0, _translate("MainWindow", "EOL"))
        self.webDBSelectButton.setItemText(1, _translate("MainWindow", "Tropicos"))
        self.webDBSelectButton.setItemText(2, _translate("MainWindow", "The Plant List"))
        self.webDBSelectButton.setItemText(3, _translate("MainWindow", "TaiCOL"))
        self.webDBSelectButton.setItemText(4, _translate("MainWindow", "IPNI"))
        self.webDBSelectButton.setItemText(5, _translate("MainWindow", "Plants of Taiwan"))
        self.webDBSelectButton.setItemText(6, _translate("MainWindow", "Plants of the World (POWO)"))
