...
"    qproperty-icon: url(:images/search.svg);\n"
"}")
...
"}")
        ...
        self.butDeleteSelection.setMinimumSize(QtCore.QSize(32, 32))
        self.butDeleteSelection.setStyleSheet("QPushButton#butDeleteSelection{\n"
"    qproperty-icon: url(:images/delete.svg);\n"
"}")
        ...
        self.butDeleteAll.setMinimumSize(QtCore.QSize(32, 32))
        self.butDeleteAll.setStyleSheet("QPushButton#butDeleteAll{\n"
"    qproperty-icon: url(:images/delete_all.svg);\n"
"}")
...
"}")
        ...
        self.gridLayout_2.addWidget(self.butNomenMatch, 3, 1, 1, 1)
